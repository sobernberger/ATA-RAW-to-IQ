...
1. Channel Bandwidth 
2. Total Bandwidth
3. Center Frequency (Header['OBSFREQ] denotes the freqency at which the middle channel starts. Therefore the center frequency can be calculating by adding half of the channels bandwidth)
